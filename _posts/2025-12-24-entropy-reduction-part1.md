...
![从混沌到秩序：语言模型的熵减过程](/images/blog/一切都是熵减_上篇_图1.png)
*图1：从高熵的混沌输入，通过语言模型（熵减机器），到低熵的有序输出*
...
![高维语义空间与低维Token空间的熵对比](/images/blog/一切都是熵减_上篇_图2.png)
*图2：上方高维语义空间中，不同的语义状态z₁、z₂、z₃清晰分离，熵低；投影到下方低维Token空间后，多个状态混叠到相同符号，造成熵虚高*
...
![Transformer的三阶段架构](/images/blog/一切都是熵减_上篇_图3.png)
*图3：Transformer的熵减策略——①升维（Embedding）将离散token映射到高维连续空间，②演化（Attention × N）在高维空间进行信息选择和整合，③投影（Softmax）将结果映射回token分布*
