...
*图1：图像空间中的信息波动——完整信息、添加噪声、去噪恢复，信息可逆*
...
*图2：图像扩散的去噪过程——从清晰图像逐步加噪到纯噪声，反向过程可逆*
...
*图3：Token空间的信息破碎——高维语义投影到离散Token后，信息已碎，难以重建*
...
*图4：图像扩散成功 vs 语言扩散困难——连续空间的平滑可逆 vs Token空间的离散混叠*
...
*图5：语言扩散的真正出路——构建连续的语义流形，在流形上实现扩散潜力*
